// Name:Kushaan Vardhan   Date: 1/25/2022  
...
public class LunchRoom
{
      ...
      *************************/
      ...
      for(int min = 0; min < 1080; min++)
      {
         if(Math.random() < CHANCE_OF_CUSTOMER)
         {
            ...
            pq.add(new Customer(min, gradYear + 2022, timeToOrderAndBeServed() ));
            noc[gradYear]++;
         }
         if(!pq.isEmpty())
         {
            Customer curr = pq.peek();
            curr.setOrderAndBeServed(-1);
            if(curr.getOrderAndBeServed() == 0)
            {
               int wt = min - curr.getAT();
               if(wt > lw[curr.getGY() -2022])
               {
                  lw[curr.getGY() -2022] = wt;
               }
               pq.remove();
               curr = pq.peek();    
            }
      ...
      while(!pq.isEmpty())
      {
         ...
         displayTimeAndQueue(minnies, pq);
         minnies++;
      }
      ...
      System.out.println("Senior\t\t" + noc[0] + "\t\t" + lw[0] + "\t\t\t" + tw[0] * 1.0/noc[0]);
      System.out.println("Junior\t\t" + noc[1] + "\t\t" + lw[1] + "\t\t\t" + tw[1] * 1.0/noc[1]);
      System.out.println("Sophomore\t" + noc[2] + "\t\t" + lw[2] + "\t\t\t" + tw[2] * 1.0/noc[2]);
      System.out.println("Freshman\t\t" + noc[3] + "\t\t" + lw[3] + "\t\t" + tw[3] * 1.0/noc[3]);
   ...
   public static class Customer implements Comparable<Customer>
   {
      ...
      {
         int gC = gradYear - other.getGY();
         if(gC == 0)
            return arrivalTime - other.getAT();
         else
            return gC;  
      }
      ...
      public String toString()
      {
         ...
         switch (gradYear)
         {
            case 2023: gradeName = "Ju"; break;
            case 2024: gradeName = "So"; break;
            case 2025: gradeName = "Fr"; break;
        }  
        return arrivalTime + ":" + gradeName;
      }
